 ...
 */
export class PopUpGuess extends PixiScene {
	...
	constructor() {
		...
		const title = new Text(i18next.t<string>("guessGame.title"), auxTextstyle);
		...
		multilineStyle.wordWrapWidth = 1050;
		multilineStyle.fontSize = 80;
		multilineStyle.align = "center";

		const body = new Text(i18next.t<string>("guessGame.instructions"), multilineStyle);
